...
--
-- Host: 192.168.99.100    Database: lookapp
-- ------------------------------------------------------
...
INSERT INTO `entidad` VALUES (1,'x','x','x','x','x','x','x',1,'x','x','x','x','x');
...
CREATE TABLE `privilegios_roles` (
  ...
  `privilegio_id` bigint(20) NOT NULL,
...
CREATE TABLE `productos` (
  ...
  `utilidad_esperada` int(11) NOT NULL,
  `id_entidad` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `productos_proveedores` (
  ...
  `proovedores_id` bigint(20) NOT NULL,
...
INSERT INTO `proveedores` VALUES (1,'5','55',1,'12345','RICARDO ENRIQUE CANTILLO CARRILLO','5');
...
CREATE TABLE `salidas_detalle` (
  ...
  `id_bien_servicio` bigint(20) NOT NULL,
...
INSERT INTO `unidad_medida` VALUES (1,'Metros',_binary '','mts');
...
--
-- Dumping routines for database 'lookapp'
--
...
-- Dump completed on 2021-03-31 19:56:40
